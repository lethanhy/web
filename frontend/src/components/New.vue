    ...
    <div class="row">
      <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
        <div class="card"
          ...
          <img src="../assets/anh-1.png"
            class="card-img-top" alt="Laptop" style="background-color: #FCF8E9;" />
          <div class="card-body">
            ...
            <button class="btn btn-primary d-block mx-auto mt-3">Add to Cart</button>
          </div>
        </div>
      </div>
